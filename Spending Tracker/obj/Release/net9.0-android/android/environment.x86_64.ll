...
@aot_dso_cache = dso_local local_unnamed_addr global [954 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.89_name, ; name: libaot-System.Reflection.Primitives.dll.so
		ptr null; void* handle
	}, ; 36
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.87_name, ; name: libaot-System.Reflection.Emit.ILGeneration.dll.so
		ptr null; void* handle
	}, ; 120
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.88_name, ; name: libaot-System.Reflection.Emit.Lightweight.dll.so
		ptr null; void* handle
	}, ; 121
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x28670e5ee9c6f491, ; from name: libaot-Spending Tracker.dll.so
		i64 u0x28670e5ee9c6f491, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Spending Tracker.dll.so
		ptr null; void* handle
	}, ; 145
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x31852bdafdf0772c, ; from name: libaot-Spending Tracker
		i64 u0x28670e5ee9c6f491, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Spending Tracker.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x39a56b74d0b88327, ; from name: Spending Tracker.dll.so
		i64 u0x28670e5ee9c6f491, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Spending Tracker.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x6cf0ecf1971dc852, ; from name: aot-Spending Tracker.so
		i64 u0x28670e5ee9c6f491, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Spending Tracker.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x9187566da56cb1a2, ; from name: Spending Tracker
		i64 u0x28670e5ee9c6f491, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Spending Tracker.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xa5ddaba03f9ee096, ; from name: libaot-Spending Tracker.so
		i64 u0x28670e5ee9c6f491, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Spending Tracker.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xbf5793c8d1b2976a, ; from name: aot-Spending Tracker
		i64 u0x28670e5ee9c6f491, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Spending Tracker.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xc08dcb2ad2adc07f, ; from name: aot-Spending Tracker.dll.so
		i64 u0x28670e5ee9c6f491, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Spending Tracker.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xc840071f85bfb4d2, ; from name: Spending Tracker.so
		i64 u0x28670e5ee9c6f491, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Spending Tracker.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [32 x i8] c"com.companyname.spendingtracker\00", align 16
...
@.DSOCacheEntry.9_name = private unnamed_addr constant [31 x i8] c"libaot-Spending Tracker.dll.so\00", align 16
...
@.DSOCacheEntry.87_name = private unnamed_addr constant [50 x i8] c"libaot-System.Reflection.Emit.ILGeneration.dll.so\00", align 16
@.DSOCacheEntry.88_name = private unnamed_addr constant [49 x i8] c"libaot-System.Reflection.Emit.Lightweight.dll.so\00", align 16
@.DSOCacheEntry.89_name = private unnamed_addr constant [43 x i8] c"libaot-System.Reflection.Primitives.dll.so\00", align 16
